            ...
            <Tabs defaultValue={defaultTab} className="w-full">
                ...
                <CardContent>
                    <TabsContent value="signin">
                         <CardDescription className="text-center mb-4">Sign in to access your predictions</CardDescription>
                        <SignInTab />
                    ...
                    <TabsContent value="signup">
                        <CardDescription className="text-center mb-4">Join to start making winning bets</CardDescription>
                        <SignUpTab />
                    </TabsContent>
                </CardContent>
            </Tabs>
